...
class DnaStudioWorkspace : public Workspace {
    Q_OBJECT
public:
    explicit DnaStudioWorkspace(QWidget *parent = nullptr);

    QString wsTitle() const override { return "DNA Studio"; }
    QString wsIconName() const override { return "dna"; }
